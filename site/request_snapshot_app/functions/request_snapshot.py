...
from request_snapshot_app.models import SnapshotRequest
...
def submit_request(request):
    if request.method == 'POST':
        ...
        # save_snapshot_request(snapshot_id, vm_name, snapshot_name, include_ram, reasoning, date_time, current_user, approvers)

        return redirect('request')
    return redirect('request')

# def save_snapshot_request(snapshot_id, vm_name, snapshot_name, include_ram, reasoning, date_time, author, approvers):
